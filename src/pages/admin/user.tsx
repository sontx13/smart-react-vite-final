...
import { callDeleteUser, callFetchApp, callFetchCompany } from "@/config/api";
import queryString from 'query-string';
import { ICompanySelect, IAppSelect } from "@/types/backend";
                ...
                <Space>
                    ...
                    >
                        <EditOutlined
                            ...
                            type=""
                            onClick={() => {
                                navigate(`/admin/user/upsert?id=${entity.id}`)
                            }}
                        />
                    </Access >
